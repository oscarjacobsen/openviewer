...
export declare class Fragment {
    ...
    static startBlockIdVector(builder: flatbuffers.Builder, numElems: number): void;
    ...
    static addComposites(builder: flatbuffers.Builder, compositesOffset: flatbuffers.Offset): void;
